...
public class GlobalSettingSwitchPreference extends SwitchPreference implements Preference.OnPreferenceClickListener {
    ...
    protected boolean getValue() {
        return Settings.Global.getInt(getContext().getContentResolver(), getKey(), 0) == 1;
    }
